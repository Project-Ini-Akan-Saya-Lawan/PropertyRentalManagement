    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Bottom Nav - directly below Reports */}
          ...
          {/* Admin User */}
          <div className="px-4 py-4 border-t-2 border-[#C9A36A]/40">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-[#C9A36A]/30 flex items-center justify-center flex-shrink-0">
                <User size={16} className="text-[#2B2B2B]" />
              </div>
              <div>
                <p className="text-xs font-bold text-[#2B2B2B]">Admin User</p>
                <p className="text-[10px] font-medium text-[#2B2B2B]/60">
                  Super User
                </p>
              </div>
            </div>
            <p className="text-[9px] font-medium text-[#2B2B2B]/40 text-center mt-3">
