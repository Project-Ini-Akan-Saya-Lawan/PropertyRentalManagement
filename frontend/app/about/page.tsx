...
const LANDMARK_FEATURES = [
  ...
  { icon: Radio, label: "High Speed", sub: "Connectivity" },
...
export default function AboutPage() {
  ...
  return (
    <>
      {/* HERO */}
      <section className="relative w-full min-h-[480px] sm:min-h-[560px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-8 py-16 sm:py-20">
          <motion.div
            ...
            className="max-w-xl"
          >
            <p className="text-[#C9A36A] text-xs font-semibold uppercase tracking-widest mb-3 sm:mb-4">
              About Us
            </p>
            <h1
              className="text-2xl sm:text-3xl md:text-5xl font-bold text-white leading-tight mb-4 sm:mb-5"
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              than just space — we deliver an ecosystem for growth,
      ...
      {/* LANDMARK */}
      <section ref={r1} className="py-10 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-start">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="relative h-64 sm:h-[420px] overflow-hidden rounded-lg"
            >
              <Image
            ...
            >
              ...
              <h2
                className="text-2xl sm:text-3xl font-bold text-[#2B2B2B] mb-4 leading-tight"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-4 sm:gap-x-8 sm:gap-y-5">
                {LANDMARK_FEATURES.map((f) => (
                  <div
                    key={f.label}
                    className="flex items-start gap-2.5 sm:gap-3"
                  >
                    <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-[#C9A36A] flex items-center justify-center flex-shrink-0">
                      <f.icon size={18} className="text-white" />
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm font-semibold text-[#2B2B2B] leading-tight">
                        {f.label}
                      </p>
                      <p className="text-xs text-[#2B2B2B]/70 mt-0.5">
                        {f.sub}
                      </p>
                    </div>
                  </div>
      ...
      {/* STATS BAR */}
      <section className="bg-[#C9A36A] py-8 sm:py-10 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-10">
          <div className="grid grid-cols-3 divide-x divide-white/30">
            {[
              ...
              <div
                key={s.label}
                className="flex items-center gap-2 sm:gap-4 px-3 sm:px-10 first:pl-0 last:pr-0"
              >
                <div className="text-white flex-shrink-0 hidden sm:block">
                  {s.icon}
                </div>
                <div>
                  <p
                    className="text-lg sm:text-2xl md:text-4xl font-bold text-white"
                    style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                  >
                    {s.value}
                  </p>
                  <p className="text-white text-[10px] sm:text-xs mt-0.5 leading-tight">
                    {s.label}
                  </p>
                </div>
              </div>
      ...
      <section
        ref={r2}
        className="py-10 sm:py-16 bg-white border-t border-gray-100"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-0 md:divide-x divide-gray-100">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={iv2 ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.5 }}
              className="md:pr-12 pb-8 md:pb-0 border-b md:border-b-0 border-gray-100"
            >
              <p className="text-[#C9A36A] text-xs font-bold uppercase tracking-widest mb-3">
                Our Vision
              </p>
              <h3
                className="text-xl sm:text-2xl font-bold text-[#2B2B2B] mb-4 leading-tight"
                style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
              >
